...
That folder is a standalone Laravel + Vue 3 MVP for `Test-task-minfin` and includes its own `README.md` plus `LLM_INSTRUCTIONS.md`, including GitHub publish commands.
