...
//            found = findChessboardCornersSB( view, s.boardSize, pointBuf, CALIB_CB_NORMALIZE_IMAGE | CALIB_CB_EXHAUSTIVE );//| CALIB_CB_ACCURACY
            break;
