...
WTrackTest::WTrackTest(QWidget *parent, turret::Application &application)
  ...
  m_editElp0 = new QLineEdit("30", this);
  ...
  m_buttonGo = new QPushButton("Track", this);
  ...
  connect(m_editAzp0, &QLineEdit::editingFinished, this, &WTrackTest::toDouble);
  connect(m_editAzA, &QLineEdit::editingFinished, this, &WTrackTest::calcSpeed);
  connect(m_editAzPh, &QLineEdit::editingFinished, this, &WTrackTest::toDouble);
  ...
  connect(m_editElp0, &QLineEdit::editingFinished, this, &WTrackTest::toDouble);
  connect(m_editElA, &QLineEdit::editingFinished, this, &WTrackTest::calcSpeed);
  connect(m_editElPh, &QLineEdit::editingFinished, this, &WTrackTest::toDouble);
...
void WTrackTest::onGotoClicked() {
  ...
  m_application.startTrackTest(m_trackTest);
}

void WTrackTest::onStopClicked() { m_application.stop(); }
