...
Standalone downloadable Laravel + Vue 3 MVP for the MinFin/NBU banking currency dashboard test assignment.
...
After downloading or copying only this `currency-dashboard/` folder, run these commands **from inside the folder** to publish it as `Mzk-Dev/Test-task-minfin`:
...
git branch -M main
git remote add origin git@github.com:Mzk-Dev/Test-task-minfin.git
git push -u origin main
```

If you already initialized a local repository in this folder, use:
